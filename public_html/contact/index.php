...
<!--[if gte IE 9]><!--><html><!--<![endif]--><head>
		...
		<title>Contact Australian Karaoke - the Karaoke professionals in Melbourne, Australia (St Kilda)</title>
		<!-- InstanceEndEditable -->
	...
	<div id="wrapper" data-role="page">
		...
		?>
            <div id="main_content" data-role="content">
              <div id="contact_wrapper" style="padding: 20px;">CONTACT</div>
              <script>
              		$("#contact_wrapper").html("<div style='width: 100%; text-align: center; margin-top: 100px;'><img src='/images/spinner-purple.gif' /></div>");
				  	$("#contact_wrapper").load("/contact-support-files/contact.php");
			  </script>
              <script>
              $("#header_contact a").css({'color':'yellow'});
              </script>
            </div>
            <?php
			//}
