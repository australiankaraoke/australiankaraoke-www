...
$ins_shoppingcart->addColumn("isDisc", "STRING_TYPE", "POST", "isDisc");
...
<!--[if gte IE 9]><!--><html><!--<![endif]--><head>
		...
		<title>Australian Karaoke Tracks - search our extensive database of CDG and DVD titles.</title>
		<!-- InstanceEndEditable -->
...
<noscript>
        ...
        <script src="/tracks-support-files/tracks.js"></script>
	...
	<div id="wrapper" data-role="page">
		...
		?>
            <div id="main_content" data-role="content">
              <div id="search_for_tracks">
	              
              </div>
              <div id="tracks_search_result">
	              
              </div>
              <script>
              $("#nav_list_item_tracks").css({'color':'yellow'});
              </script>
            </div>
