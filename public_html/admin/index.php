...
<noscript>
	...
	<div id="wrapper" data-role="page">
		...
		?>
            <div id="main_content" data-role="content" style="padding: 20px;">
              
              <ul style="float: left; width: 100px; font-size: 14px;">
              <li style="list-style:none; padding: none; margin: none; padding-top: 25px;"><a href="#" id="manufacturers">Manufacturers</a><br />
              (<a href="#" id="manufacturerimages">images</a>)</li><br />
              <li style="list-style:none; padding: none; margin: none;"><a href="#" id="categories">Categories</a></li>
              <li style="list-style:none; padding: none; margin: none;"><a href="#" id="subcategorygroups">Sub-Groups</a>
              <li style="list-style:none; padding: none; margin: none;"><a href="#" id="subcategories">Sub-Categories</a></li><br />
              <li style="list-style:none; padding: none; margin: none;"><a href="#" id="products">Products</a><br />(<a href="#" id="productimages">images</a>)</li>
              <li style="list-style:none; padding: none; margin: none;"><a href="#" id="productonsell">Product On-Sell</a><br /><br />
          	  <li style="list-style:none; padding: none; margin: none;"><a href="#" id="systems">Systems</a><br /><br />
          	  <li style="list-style:none; padding: none; margin: none;"><a href="#" id="blog">Blog & Updates</a><br /><br />
              </ul>
              
              <div style="float: right; width: 1050px; border-left: 1px solid rgba(0,0,0,0.5);" id="admin_content">
		...
		?>
        <script type="text/javascript" src="/admin/scripts/admin_main.js"></script>
        <script>
