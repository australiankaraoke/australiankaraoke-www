...
//if(preg_match('/(?i)msie [1-8]/',$_SERVER['HTTP_USER_AGENT'])){
//	header("LOCATION: http://www.australiankaraoke.com.au/index-ie.php");
//} else if (preg_match('/(?i)msie [9-10]/',$_SERVER['HTTP_USER_AGENT'])){
//
//}
...
<!--[if gte IE 9]><!--><html><!--<![endif]--><head>
		...
		<title>Australian Karaoke Pty. Ltd. | Melbourne's No1 Shop for Complete Karaoke Systems, Karaoke Machines, Components and Tracks!</title>
		<!-- InstanceEndEditable -->
        ...
        <link type="text/css" href="/frameworks/jquery-list-style-rotator/list-rotator.css" rel="stylesheet"/>
        ...
        <script type="text/javascript" src="index-support-files/index.js"></script>
	...
	<div id="wrapper" data-role="page">
		...
		?>
            <div id="main_content" data-role="content">
              	<div id="nivo_content" style="z-index: 0;"></div>
              	<div id="mini_blog_content" style="z-index: 10;"></div>
              	<div id="products_slider_content" style="z-index: 10;"></div>
              	<div id="manufacturers_categories_content" style="z-index: 10;"></div>
              	<div></div>
            </div>
            <?php
			//}
