...
//if(preg_match('/(?i)msie [1-8]/',$_SERVER['HTTP_USER_AGENT'])){
	//header("LOCATION: http://www.australiankaraoke.com.au/index-ie.php");
//}
require_once('../../Connections/karaoke_db.php'); ?>
<?php
...
<!--[if gte IE 9]><!--><html><!--<![endif]--><head>
		...
		<title>Australian Karaoke Pty. Ltd. | Search our products for Complete Karaoke Systems, Karaoke machines, components and tracks!</title>
		<!-- InstanceEndEditable -->
	...
	<div id="wrapper" data-role="page">
		...
		?>
            <div id="main_content" data-role="content">
              <div id="products_content" style="position: relative; float: left; width: 100%; margin-top: 25px; padding: 20px;"></div>
                  <script>
				  	$("#products_content").load("/search-support-files/query-products.php",{productQuery : '<?php echo $_GET['global_search_query']; ?>'});
				  </script>
