...
<!--[if gte IE 9]><!--><html><!--<![endif]--><head>
		...
		<title>Australian Karaoke Pty. Ltd. | your shopping cart!</title>
		<!-- InstanceEndEditable -->
...
<noscript>
        ...
        <script type="text/javascript" src="../shopping-cart-support-files/shopping-cart.js"></script>
	...
	<div id="wrapper" data-role="page">
		...
		?>
            <div id="main_content" data-role="content">
              ...
              <script>
              $("#header_cart a").css({'color':'yellow'});
              </script>
            </div>
            <?php
			//}
