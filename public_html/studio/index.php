...
<!--[if gte IE 9]><!--><html><!--<![endif]--><head>
		...
		<title>Australian Karaoke Studio - professional vocal and multimedia studio. Flexible hourly/daily rates.</title>
		<!-- InstanceEndEditable -->
	...
	<div id="wrapper" data-role="page">
		...
		?>
            <div id="main_content" data-role="content">
              <div style="padding: 25px;">We are busy updating our "Studio" section ... please stand by!</div>
              <script>
              $("#nav_list_item_studio").css({'color':'yellow'});
              </script>
            </div>
            <?php
			//}
